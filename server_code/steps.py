...
def add_new_step(step_name, step_description, vision, ai_generated=False):
  ...
  app_tables.steps.add_row(step_name=step_name, step_description=step_description, created_at=current_datetime, vision=vision, ai_generated=ai_generated)
...
def remove_step(step):
  ...
  if app_tables.steps.has_row(step):
    ...
    # Question Scores
    anvil.server.call('delete_score', step=step)
